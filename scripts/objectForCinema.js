const movies = [
  ...
  },
  {
    ...
    format: '2D IMAX',
    script:
      'Sau khi gặp tổng thống Hoa Kỳ mới đắc cử Thaddeus Ross, Sam phải đối mặt với một sự cố quy mô quốc tế. Anh phải tìm ra mục đích đằng sau trước khi kẻ chủ mưu khiến cả thế giới phải khiếp sợ',
    actors: [
      {
  ...
  },
  {
    ...
    format: '2D',
    script:
      'Drop / Buổi Hẹn Hò Kinh Hoàng diễn ra khi Buổi hẹn hò đầu tiên sau nhiều năm của Violet nhanh chóng trở thành ác mộng khi cô nhận được những tin nhắn ẩn danh kỳ lạ. Kẻ gửi đe dọa giết con trai và em gái cô nếu cô không làm theo yêu cầu của hắn',
    actors: [
      {
  ...
  },
  {
    ...
    format: '2D',
    script:
      'Phiên bản chuyển thể người đóng của bộ phim hoạt hình Bạch Tuyết & Bảy chú lùn của Disney năm 1937.',
    actors: [
      {
